...
@client.event
async def on_ready():
    await client.change_presence(activity=discord.Activity(name=";help", type=discord.ActivityType(0),state="Tea party with Abijith",details="Drinking tea & eating biscuits",party={"size":[2,2]} ))
    print ("Bot is ready")
    print('Logged in as')
