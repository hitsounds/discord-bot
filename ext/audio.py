...
class voice:
    def __init__(self, client):
        ...
        self.args = {
            ...
            "mkv" : "youtube-dl --max-filesize 0.8g --no-playlist --default-search \"auto\" -f 'bestvideo+bestaudio/best' --merge-output-format mkv --add-metadata --postprocessor-args '-movflags faststart' -o "
        }
